...
const EditProfile = () => {
  ...
  const [_uploadedAvatar, setUploadedAvatar] = useState<File | null>(null);
  ...
  const handleDelete = async () => {
    const { success, message } = await userRequests.deleteProfile();
          ...
          <div className="space-y-6 sm:space-y-8 mt-6 sm:mt-10 pt-4 sm:pt-5 border-t border-[gray]">
            ...
            <div>
              ...
              <div className="flex flex-col items-start gap-3 sm:gap-2">
                <div
                  className="w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] rounded-xl flex items-center justify-center cursor-pointer hover:opacity-50"
